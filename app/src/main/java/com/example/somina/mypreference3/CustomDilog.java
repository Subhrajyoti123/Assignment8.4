package com.example.somina.mypreference3;
...
public class CustomDilog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity().getApplicationContext()).inflate(R.layout.custom_dilog, null);
